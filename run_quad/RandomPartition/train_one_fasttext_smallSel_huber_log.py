...
test_data_predictions_labels_file = os.path.join('./test_fasttext_smallSel_huber_log_greedy_clusters', 'test_predictions_labels')
valid_data_predictions_labels_file = os.path.join('./valid_fasttext_smallSel_huber_log_greedy_clusters', 'valid_predictions_labels')
regression_name = 'fasttext_smallSel_huber_log_greedy_clusters_'
regression_model_dir = './model_dir_fasttext_smallSel_huber_log_greedy_clusters/regression_CTNet'
