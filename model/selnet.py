...
class SelNet(object):
    def __init__(self,
        ...
        # types of spline
        self.spline_type = 'cardnet_linear'
    ...
    def __ae__(self, x_input):
        '''
        Transfer original X to dense representation, replace VAE
        :param x_input:
        :return:
        '''
        # Encoder
    ...
    def _construct_rhos_(self, x_fea, x_fea_dr):
        '''
        :param x_fea:
        :param x_fea_dr:
    ...
    def _construct_rhos(self, x_fea, x_fea_dr, expert_name='default_expert'):
        '''
        :param x_fea:
        :param x_fea_dr:
        :param tau: a matrix with N * num_deltataus
    ...
    def train(self, train_X, train_tau, train_y, valid_X, valid_tau, valid_y, test_X, test_tau, test_y):
        if self.spline_type == 'cardnet_linear':
